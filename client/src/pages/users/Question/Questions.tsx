  ...
  return (
    <>
      <UpperTriangleBox
        sx={{
          height: "100%",
          flex: !scenarioEndPopup ? "1" : "0",
          borderRadius: !scenarioEndPopup ? "0" : "20px",
          margin: !scenarioEndPopup ? "-160px 0 0" : "72px 20px ",
            ...
            <>
              ...
              >
                <Typography
                  ...
                  marginTop={"16px"}
                >
                  Scenario {scenarioEndPopup?.scenario}
                </Typography>
                <Typography
                  textAlign={"center"}
                  fontSize={"15px"}
